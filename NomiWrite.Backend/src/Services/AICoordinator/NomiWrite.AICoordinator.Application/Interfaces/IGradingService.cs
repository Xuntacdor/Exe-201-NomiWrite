...
public interface IGradingService
{
    ...
    Task<GradingResultDto?> GetGradingResultBySubmissionIdAsync(Guid submissionId, Guid userId, string? accessToken = null);
    Task<IReadOnlyList<GradingHistoryItemDto>> GetGradingHistoryAsync(Guid userId);
    Task<ComparisonDto> CompareWithPreviousAttemptAsync(Guid userId, Guid submissionId, string? accessToken = null);
