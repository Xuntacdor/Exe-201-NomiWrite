...
using NomiWrite.AICoordinator.API.Middleware;
using NomiWrite.AICoordinator.Infrastructure;
...
builder.Services.AddAICoordinatorInfrastructure(builder.Configuration);
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "NomiWrite AI Coordinator Service",
        Version = "v1"
    });
...
builder.Services.AddHealthChecks()
    .AddDbContextCheck<GradingDbContext>("grading_db");
builder.Services.AddControllers()
